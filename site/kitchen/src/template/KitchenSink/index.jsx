  ...
  render() {
    ...
    return (
      <IntlProvider locale={appLocale.locale} messages={appLocale.messages}>
        <div className="ej-demo-page">
          <div className="ej-demo-hd">
            <h1 className="ej-demo-title"><FormattedMessage id="app.site.title" /></h1>
            <h2 className="ej-demo-subtitle"><FormattedMessage id="app.site.subTitle" /></h2>
          </div>
          <div className="ej-demo-bd">
            {
              Object.keys(lists)
                  ...
                  <List
                    ...
                    renderHeader={() => (
                      <div
                        ...
                        className="ej-demo-category"
                      >
                        <div className="ej-demo-category-name">{appLocale.locale === 'en-US' ? cate : `${config.cateChinese[cate]} ${cate}`}</div>
                        <div className="ej-demo-category-arrow"><span><Icon type="down" /></span></div>
                      </div>
                    )}
