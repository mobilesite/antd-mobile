...
const customIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42 42" className="ej-icon ej-icon-md">
...
````css
.stepsExample .timeline.ej-steps.ej-steps-small
.ej-steps-item.ej-steps-custom
.ej-steps-head-inner > .ej-steps-icon {
  width: 8px;
  height: 8px;
  border-radius: 50%;
  background-color: #d9dff1;
}
.stepsExample .timeline.ej-steps.ej-steps-small .ej-steps-tail {
  top: 3px;
  padding: 0 8px;
