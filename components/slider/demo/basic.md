...
class App extends React.Component {
  ...
  render() {
    return (
      <div className="ej-slider-example">
        <WhiteSpace size="lg" />
        <WingBlank size="lg">
...
````css
.demo-preview-item .ej-slider-wrapper {
  margin-bottom: 15px;
}
.demo-preview-item .ej-slider-example {
  overflow: hidden;
}
.ej-wingblank.ej-wingblank-lg {
  margin-bottom: 30px;
}
.demo-preview-item .ej-slider-wrapper:last-child {
  margin-bottom: 10px;
}
.sub-title {
  color: #888;
