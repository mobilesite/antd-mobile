...
describe('ActionSheet', () => {
  it('showActionSheetWithOptions correctly', () => {
    ...
    expect([document.querySelector('.ej-action-sheet')]).toHaveLength(1);
    document.querySelectorAll('.ej-action-sheet-button-list-item')[0].click();
  });
  ...
  it('showShareActionSheetWithOptions correctly', () => {
    ...
    expect([document.querySelector('.ej-action-sheet-share')]).toHaveLength(1);
    document.querySelectorAll('.ej-action-sheet-share-list-item')[1].click();
  });
});
